    ...
    <v-row>
      <v-col>
          ...
          <div class="category-list">
            <div class="category" v-for="category in categories" :key="category.id" :style="{ backgroundColor: category.color }">
              <div class="category-header" @click="toggleSubtopics(category)">
                <i :class="category.icon"></i>
                <span class="category-title">{{ category.title }}</span>
                <i :class="{'mdi mdi-chevron-down': category.showSubtopics, 'mdi mdi-chevron-up': !category.showSubtopics}"></i>
              </div>
              <div class="subtopics" v-if="category.showSubtopics">
                <div class="subtopic" v-for="subtopic in category.subtopics" :key="subtopic.id" :style="{ backgroundColor: category.color }" @click="selectSubtopic(category, subtopic)">
      ...
      <v-col>
        <v-card> <category-details :category="selectedCategory" :subtopic="selectedSubtopic"></category-details></v-card>
...
export default {
      ...
      categories: [
        {
          ...
          showSubtopics: false,
          subtopics: [
            { id: 1, title: 'Salud Primaria', pob_value: 20 ,
        grid: [
        ...
        },
        {
          ...
          showSubtopics: false,
          subtopics: [
            { id: 1, title: 'Educación Básica', pob_value: 80, grid: [
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
          ['red', 'red', 'green', 'red', 'green', 'red']
            ...
            { id: 2, title: 'Educación Media', pob_value: 75,  grid: [
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
        ...
        },
        {
          ...
          showSubtopics: false,
          subtopics: [
            { id: 1, title: 'Bibliotecas', pob_value: 50,  grid: [
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
          ['red', 'red', 'green', 'red', 'green', 'red']
            ...
            { id: 2, title: 'Sedes Sociales', pob_value: 65,  grid: [
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
        ...
        },
        {
          ...
          showSubtopics: false,
          subtopics: [
            { id: 1, title: 'Gimnasios', pob_value: 30,  grid: [
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
          ['red', 'red', 'green', 'red', 'green', 'red']
            ...
            { id: 2, title: 'Multicanchas', pob_value: 40,  grid: [
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
          ['red', 'red', 'green', 'red', 'green', 'red']
            ...
            { id: 3, title: 'Canchas de Fútbol', pob_value: 75, grid: [
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
        ...
        },
        {
          ...
          showSubtopics: false,
          subtopics: [
            { id: 1, title: 'Áreas Verdes', pob_value: 75,  grid: [
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
          ['red', 'red', 'green', 'red', 'green', 'red']
            ...
            { id: 2, title: 'Parques', pob_value: 75 ,  grid: [
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ['green', 'green', 'red', 'green', 'red', 'green'],
        ...
        },
        {
          ...
          showSubtopics: false,
          subtopics: [
            { id: 1, title: 'Subtopic 6.1' , pob_value: 75,  grid: [
          ['green', 'red', 'green', 'red', 'green', 'red'],
          ...
          ['red', 'red', 'green', 'red', 'green', 'red']
            ...
            { id: 2, title: 'Subtopic 6.2', pob_value: 75 ,  grid: [
  ...
  methods: {
    ...
    selectSubtopic(category, subtopic) {
      ...
      this.$emit('categorySelected', this.selectedCategory, this.selectedSubtopic);
    }
  },
  mounted() {
